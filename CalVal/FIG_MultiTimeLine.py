...
def FIG_multi_time_line(fls8_df, fs2a_df, fs2b_df, ls8_csvs, sent_csvs, rain_dat, field_data, output, fignum):
    ...
    axes[0].plot(krain.index, krain.rain, c='#FFBBBB', zorder = 5)
    ...
    axes[1].plot(krain.index, krain.rain, c='#FFBBBB', zorder = 5)
    ...
    axes[2].plot(krain.index, krain.rain, c='#FFBBBB', zorder = 5)
    ...
    axes[3].plot(krain.index, krain.rain, c='#FFBBBB', zorder = 5)
    ...
    axes[4].plot(krain.index, krain.rain, c='#FFBBBB', zorder = 5)
    ...
    axes[5].plot(krain.index, krain.rain, c='#FFBBBB', zorder = 5)
    ...
    axes[6].plot(krain.index, krain.rain, c='#FFBBBB', zorder = 5)
    ...
    axes[7].plot(krain.index, krain.rain, c='#FFBBBB', zorder = 5)
    ...
    axes[8].plot(krain.index, krain.rain, c='#FFBBBB', zorder = 5)
    ...
    axes[9].plot(krain.index, krain.rain, c='#FFBBBB', zorder = 5)
    ...
    axes[10].plot(krain.index, krain.rain, c='#FFBBBB', zorder = 5)

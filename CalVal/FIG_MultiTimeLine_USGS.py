...
def FIG_multi_time_line(fls8_df, fls8_usgs_df, ls8_csvs, rain_dat, field_data, output, fignum):
    ...
    axes2.scatter(x=ls8_usgs_times, y=fls8_usgs_df.loc['band1'][ls8_usgs_means], color='orange', s=20, zorder=10)
    ...
    axes2.scatter(x=ls8_usgs_times, y=fls8_usgs_df.loc['band2'][ls8_usgs_means], color='orange', s=20, zorder=10)
    ...
    axes2.scatter(x=ls8_usgs_times, y=fls8_usgs_df.loc['band3'][ls8_usgs_means], color='orange', s=20, zorder=10)
    ...
    axes2.scatter(x=ls8_usgs_times, y=fls8_usgs_df.loc['band4'][ls8_usgs_means], color='orange', s=20, zorder=10)
    ...
    axes2.scatter(x=ls8_usgs_times, y=fls8_usgs_df.loc['band5'][ls8_usgs_means], color='orange', s=20, zorder=10)
    ...
    axes2.scatter(x=ls8_usgs_times, y=fls8_usgs_df.loc['band6'][ls8_usgs_means], color='orange', s=20, zorder=10)
    ...
    axes2.scatter(x=ls8_usgs_times, y=fls8_usgs_df.loc['band7'][ls8_usgs_means], color='orange', s=20, zorder=10)

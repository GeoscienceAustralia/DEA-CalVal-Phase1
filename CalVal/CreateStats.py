...
def create_stats(sat_array, ground_brdf, field_data):
    if field_data[3] == 'Landsat8':
        ...
        data_array = np.array([['','Sat_mean','Sat_SD', 'Field_mean', 'Field_SD'],
                        ...
                        ['Band3', float(sat_array.nbar_green.mean()/10000), float(sat_array.nbar_green.std()/10000), float(ground_brdf['band3'].mean()), float(ground_brdf['band3'].std())],
                        ['Band4', float(sat_array.nbar_red.mean()/10000), float(sat_array.nbar_red.std()/10000), float(ground_brdf['band4'].mean()), float(ground_brdf['band4'].std())],
                        ['Band5', float(sat_array.nbar_red_edge_1.mean()/10000), float(sat_array.nbar_red_edge_1.std()/10000), float(ground_brdf['band5'].mean()), float(ground_brdf['band5'].std())],
                        ['Band6', float(sat_array.nbar_red_edge_2.mean()/10000), float(sat_array.nbar_red_edge_2.std()/10000), float(ground_brdf['band6'].mean()), float(ground_brdf['band6'].std())],
                        ['Band7', float(sat_array.nbar_red_edge_3.mean()/10000), float(sat_array.nbar_red_edge_3.std()/10000), float(ground_brdf['band7'].mean()), float(ground_brdf['band7'].std())],
                        ['Band8', float(sat_array.nbar_nir_1.mean()/10000), float(sat_array.nbar_nir_1.std()/10000), float(ground_brdf['band8'].mean()), float(ground_brdf['band8'].std())],
                        ['Band8a', float(sat_array.nbar_nir_2.mean()/10000), float(sat_array.nbar_nir_2.std()/10000), float(ground_brdf['band8a'].mean()), float(ground_brdf['band8a'].std())],
                        ['Band11', float(sat_array.nbar_swir_2.mean()/10000), float(sat_array.nbar_swir_2.std()/10000), float(ground_brdf['band11'].mean()), float(ground_brdf['band11'].std())],
                        ['Band12', float(sat_array.nbar_swir_3.mean()/10000), float(sat_array.nbar_swir_3.std()/10000), float(ground_brdf['band12'].mean()), float(ground_brdf['band12'].std())],
                        ])

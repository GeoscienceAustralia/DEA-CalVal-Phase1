...
def FIG_sat_field_avg_scatter_compare(sat_array, field_array, plot_scale, fstat_df, output, field_data, fignum):
    ...
    if field_data[3] == 'Sentinel2a' or field_data[3] == 'Sentinel2b':
        ...
        plt.figtext(0.190, 0.867, "Band 1 - Coastal Aerosol")
        plt.figtext(0.190, 0.843, "Band 2 - Blue")
        plt.figtext(0.190, 0.820, "Band 3 - Green")
        plt.figtext(0.190, 0.797, "Band 4 - Red")
        plt.figtext(0.190, 0.775, "Band 5 - Red Edge 1")
        plt.figtext(0.190, 0.752, "Band 6 - Red Edge 2")
        plt.figtext(0.190, 0.727, "Band 7 - Red Edge 3")
        plt.figtext(0.190, 0.704, "Band 8 - NIR")
        plt.figtext(0.190, 0.679, "Band 8a - Narrow NIR")
        plt.figtext(0.190, 0.654, "Band 11 - SWIR 2")
        plt.figtext(0.190, 0.631, "Band 12 - SWIR 3")
        ...
        plt.figtext(0.190, 0.869, "Band 1 - Coastal Aerosol")
        plt.figtext(0.190, 0.846, "Band 2 - Blue")

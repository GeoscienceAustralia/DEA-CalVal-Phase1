...
def create_SUB_stats(ls_sat_array, s2_sat_array, ls_field_array, s2_field_array, ls_ground_brdf, s2_ground_brdf, ls_fstat_df, s2_fstat_df, field_data):
    ...
    ls_inner_array = np.array([['', 'Sat_inner_mean', 'Sat_SD', 'Field_inner_mean'],
                        ['Band1', float(ls_subsat_array.nbart_coastal_aerosol[0].mean()/10000), float(ls_subsat_array.nbart_coastal_aerosol[0].std()/10000), float(ls_ground_brdf['band1'].mean())],
                        ['Band2', float(ls_subsat_array.nbart_blue[0].mean()/10000), float(ls_subsat_array.nbart_blue[0].std()/10000), float(ls_ground_brdf['band2'].mean())],
                        ['Band3', float(ls_subsat_array.nbart_green[0].mean()/10000), float(ls_subsat_array.nbart_green[0].std()/10000), float(ls_ground_brdf['band3'].mean())],
                        ['Band4', float(ls_subsat_array.nbart_red[0].mean()/10000), float(ls_subsat_array.nbart_red[0].std()/10000), float(ls_ground_brdf['band4'].mean())],
                        ['Band5', float(ls_subsat_array.nbart_nir[0].mean()/10000), float(ls_subsat_array.nbart_nir[0].std()/10000), float(ls_ground_brdf['band5'].mean())],
                        ['Band6', float(ls_subsat_array.nbart_swir_1[0].mean()/10000), float(ls_subsat_array.nbart_swir_1[0].std()/10000), float(ls_ground_brdf['band6'].mean())],
                        ['Band7', float(ls_subsat_array.nbart_swir_2[0].mean()/10000), float(ls_subsat_array.nbart_swir_2[0].std()/10000), float(ls_ground_brdf['band7'].mean())],
                       ])
